...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	@Autowired
	public void configuracaoGlobal(AuthenticationManagerBuilder auth, UserInfoService user) throws Exception{
		auth.userDetailsService(user).passwordEncoder(this.encorder());
	}
